...
**Bookstore** is a website similar to my Awesome Books project, but way better and built using React and Redux. It allows users to display, add and remove books.
...
Feel free to check the [issues page](https://github.com/Botlhale-Setou/bookstore/issues).
